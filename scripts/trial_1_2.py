...
def main():
    ...
    model_names = {'default': 'bert-large-cased',
    #        '/dati/models/lmkbc_checkpoints/mlm_checkpoints_baseline_withsoftmax_multilm_lr5e-6_10_0_development/best_ckpt',
                   'ChemicalCompoundElement': None,
                   'CompanyParentOrganization': None, 
                   'CountryBordersWithCountry': None, 
                   'CountryOfficialLanguage': None, 
                   'PersonCauseOfDeath': None,
                   'PersonEmployer': None,
                   'PersonInstrument': None,
                   'PersonLanguage': None, 
                   'PersonPlaceOfDeath': None,
                   'PersonProfession': None,
                   'RiverBasinsCountry': None,                                         
                   'StateSharesBorderState': None
                   }
